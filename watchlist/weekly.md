...
Type: incremental vs 2026-09-10  
Sources: android-official / engineering / open-source / ai-android  
本周新日报：仅 `open-source` 2026-09-11。
...
| android-skills | Android CLI + official skills | AI / Tooling | ai-android + oss | skills v1.0.11 + AppFunctions skill | Adopt | 2026-09-10 | 2026-09-11 |
...
| dagger-ksp | Dagger / Hilt KSP | Official / Build | open-source | Docs: stable since Dagger 2.60+ / KSP 2.3.9+ | Adopt | 2026-09-11 | 2026-09-11 |
| compose-lints | compose-lints 1.6.0 | Engineering | open-source | Slack production Compose lint | Adopt | 2026-09-11 | 2026-09-11 |
...
| adk-kotlin | ADK for Kotlin | AI / OSS | open-source | 1.0.1; main: MCP reject + onRunError | Trial | 2026-09-10 | 2026-09-11 |
| maestro-mcp | Maestro MCP | AI / Testing | ai-android | YAML stays in CI | Trial | 2026-09-10 | 2026-09-10 |
| kuikly | KuiklyUI | Domestic OSS | open-source | 2.27.0 + KuiklyUI-AI | Trial | 2026-09-10 | 2026-09-11 |
| appfunctions | AppFunctions (on-device MCP) | Official / AI | open-source | Jetpack 1.0.0-alpha10; samples + skill | Trial | 2026-09-11 | 2026-09-11 |
...
| circuit-038 | Circuit 0.38 | Architecture | open-source | Screen no longer Parcelable; Compose 1.12.1 / BM 1.5.0 | Assess | 2026-09-10 | 2026-09-11 |
...
| paparazzi-2 | Paparazzi 2.0-alpha05 | OSS / Testing | open-source | a11y HideFromAccessibility; drop synthetic insets | Assess | 2026-09-10 | 2026-09-11 |
| mnn | Alibaba MNN | Domestic OSS / AI | open-source | 3.6.1; drop STS/telemetry; Qwen3-TTS decode | Assess | 2026-09-10 | 2026-09-11 |
| lynx-41 | Lynx 4.1.0 | Domestic OSS | open-source | monthly + Autolink; pin 4.1.0, do not follow develop | Trial* | 2026-09-10 | 2026-09-11 |
...
| hotfix-stack | Tinker/Shadow/Atlas/AndFix/Robust | Domestic OSS | open-source | inactive generation | Hold | 2026-09-10 | 2026-09-11 |
| legacy-tools | Flipper/AMD/ByteX | OSS | open-source | archived | Hold | 2026-09-10 | 2026-09-11 |
| dual-runtime | ADK + MNN dual runtime | AI | weekly merge | pick one stack | Hold | 2026-09-10 | 2026-09-11 |
| appfn-adk-merged | AppFunctions + ADK one milestone | AI | weekly merge | two tracks, two PoCs | Hold | 2026-09-11 | 2026-09-11 |
...
- Adopt: 10
- Trial: 11（主表含 AppFunctions；Lynx 为条件 Trial，雷达主表跨端仍以 Kuikly 代表）
- Assess: 10
- Hold: 8

## Next-run rule

下一轮只对比本表的 Version / Signal / Rec。三者都不变则不要重写周报对应章节。下一快照：`snapshots/weekly/2026-09-11.md`。
